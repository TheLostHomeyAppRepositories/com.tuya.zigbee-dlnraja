# 📚 Tutoriel - rain_sensor

## 🎯 Vue d'ensemble
Ce tutoriel vous guide dans l'installation et la configuration du driver **rain_sensor** pour Homey.

## 📋 Prérequis
- Homey avec firmware 8.0+
- Application Tuya Zigbee installée
- Appareil compatible rain_sensor
...
3. Recherchez "rain_sensor"
4. Cliquez sur "Installer"

### Étape 2: Configuration
1. Appuyez sur le bouton "+" pour ajouter un appareil
2. Sélectionnez "rain_sensor" dans la liste
